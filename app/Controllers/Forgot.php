...
class Forgot extends BaseController
{
    ...
    {
        return view('password_reset_request_view');
    }
    ...
    public function store()
    {
        ...
        if (!$UserFound) {
            session()->setFlashdata('error', 'Não encontramos seu email, favor se cadastre!');
    ...
    public function edit($token)
    {
        ...
        return view('password_reset_form_view', ['token' => $token]);
    }
