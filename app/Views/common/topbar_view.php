...
<div class="top-bar center">
         ...
         <div class="search">
            <form action="<?= base_url('/items/search') ?>" method="get">
                <input type="text" name="search" placeholder="Buscar itens disponíveis..." style="flex: 1; padding: 10px; border-radius: 20px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
